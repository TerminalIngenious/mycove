...
import { FileText, FolderOpen, User, Settings, X } from 'lucide-react';
...
export function MenuPlus({ isOpen, onClose }: MenuPlusProps) {
  ...
  const menuItems = [
    ...
    },
    {
      id: 'administratif',
      label: 'Administratif',
      description: 'CAF, mutuelle, impôts...',
      icon: FolderOpen,
      color: '#22D3EE',
      route: '/administratif',
    },
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-[#1E293B] rounded-t-3xl border-t border-[#334155] animate-slide-up">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between px-6 pb-4">
            ...
            <button onClick={onClose} className="w-8 h-8 rounded-lg bg-[#0F172A] border border-[#334155] flex items-center justify-center hover:border-[#22D3EE]/50 transition-colors">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 text-left">
                    ...
                    <div className="text-xs text-[#64748B] leading-snug">{item.description}</div>
                  </div>
                </button>
              );
            })}

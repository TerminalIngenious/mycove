...
const options: Option[] = [
  ...
  { id: 'bts', emoji: '🏫', titre: 'BTS', sousTitre: 'Brevet de Technicien Supérieur' },
  { id: 'but', emoji: '⚙️', titre: 'BUT', sousTitre: 'Bachelor Universitaire de Technologie' },
  { id: 'prepa', emoji: '📐', titre: 'Prépa', sousTitre: 'Classes Préparatoires' },
];
  ...
  return (
    <MobileContainer>
      <div className="flex min-h-screen flex-col px-6 py-16 pb-32">
        <h1 className="mb-8 text-[32px] font-bold text-[#F8FAFC]">
          Niveau d'études
        </h1>
